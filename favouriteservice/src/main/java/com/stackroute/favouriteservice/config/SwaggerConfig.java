...
public class SwaggerConfig {
	private static final String API_NAME = "Favourite Service API";
	private static final String PACKAGE_SCAN = "com.stackroute.favouriteservice.controller";
	...
	private ApiInfo apiMetaInfo() {
		return new ApiInfo(API_NAME, "Favourite Service", "1.0", "https://stackbooks-ust.stackroute.in/", "Stackroute Admin",
				"Favourite Service 1.0", "https://www.apache.org/licenses/LICENSE-2.0");
	}
}