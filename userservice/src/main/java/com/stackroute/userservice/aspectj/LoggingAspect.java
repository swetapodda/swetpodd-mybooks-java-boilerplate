...
public class LoggingAspect {
	...
	@Before("execution(* com.stackroute.userservice.controller.UserAuthenticationController.*(..))")
	public void logBefore(JoinPoint point) {
		log.info(point.getSignature().getName() + " before called...");
	}

	@After("execution(* com.stackroute.userservice.controller.UserAuthenticationController.*(..))")
	public void logAfter(JoinPoint point) {
		log.info(point.getSignature().getName() + " after called...");
	}

	@AfterReturning("execution(* com.stackroute.userservice.controller.UserAuthenticationController.*(..))")
	public void logAfterReturning(JoinPoint point) {
		log.info(point.getSignature().getName() + " after returning called...");
	}

	@AfterThrowing("execution(* com.stackroute.userservice.controller.UserAuthenticationController.*(..))")
